...
class AppConfig @Inject() (config: Configuration) extends ServicesConfig(config):
  ...
  val eisExportMessagePath: String            = config.get[String]("microservice.services.eis-api.exportMessagePath")
  val eisSubscriptionMessagePath: String      = config.get[String]("microservice.services.eis-api.subscriptionMessagePath")
  val eisExtractBearerToken: String           = config.get[String]("microservice.services.eis-api.extractBearerToken")
  val eisSubscriptionBearerToken: String      = config.get[String]("microservice.services.eis-api.subscriptionBearerToken")
  ...
  val logIncomingMessages: Boolean            = config.get[Boolean]("microservice.features.logIncomingMessages")
  val handleErrorReports: Boolean             = config.get[Boolean]("microservice.features.handleErrorReports")
  val subscriptionResponsePartner: String     = config.get[String]("subscriptions.partner")
